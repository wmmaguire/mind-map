...
Last updated: 2026-04-15 — **Graph insights assess (branch `issue-83-graph-insights`):** **`POST /api/graph-insights-assess`** — psychoanalytic prompt (**3** guiding questions: structure, theme/meaning, direction/inspiration), **2–3** paragraphs, `max_tokens` **1100**; **`jones`** (Alex Jones parody) on client **`INSIGHT_ASSESS_TONE_OPTIONS`** + server **`TONE_IDS`**. Docs: **`client/README.md`**, **`server/READEME.md`**, **`docs/github-backlog-issues.md`**. GitHub: comments on **#83**, **#95**, **#96**; backlog **#97** (tone id parity).
