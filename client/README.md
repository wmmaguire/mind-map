...
10. **Insights (#83):** **View → Insights** — snapshot metrics; expand **Top by degree**; **Focus** matches **Focus next**. **Assess graph** (API running): pick a **Voice**, run assessment; use **Copy** / **Save** / **Close**. Reload confirms **`mindmap.chrome.insightsPanelVisible`**. Tests: **`graphInsights.test.js`**.
